...
exports.index = function(req, res){
	...
	var startDate = (req.query.start_date) ? new Date(req.query.start_date) : undefined; //new Date(new Date().getTime() - FIVE_MINUTES_IN_MS);

    //gestion pagination
    var start = (req.query.start) ? parseInt(req.query.start) : 0;
    var limit = (req.query.limit) ? parseInt(req.query.limit) : maxMessages;
